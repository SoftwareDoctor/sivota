...
public class EmailDetails {
    ...
    public static String generateBodyLinkWithUUID(UUID uuidVotazione) {
        String uuidString = uuidVotazione.toString();
        String body = "<html><body style='font-family: Arial, sans-serif; color: #333;'>"
                ...
                + "<p style='text-align: center;'><a href='http://example.com/vote?id=" + uuidString + "' style='display: inline-block; padding: 10px 20px; background-color: #007bff; color: white; text-decoration: none; border-radius: 5px;'>Link alla votazione</a></p>"
                + "</div>"
                + "</body></html>";
        return body;
    }
